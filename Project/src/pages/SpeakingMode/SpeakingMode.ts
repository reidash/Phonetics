...
export class SpeakingMode {
    ...
    constructor(public navCtrl: NavController, public navParams: NavParams, public plt: Platform, private toastCtrl: ToastController) {
		this.platform = plt;
...
presentToast(message) {
    ...
    autoAdvance = function () {
        ...
        if (this.currState === this.state.right) {
			console.log("In state right, should be timing out");
            timeout = 1500;
        }
